...
<<<<<<<< HEAD:components/button-group/README.md
<script type="module" src="./button-group.js"></script>
========
<script type="module" src="/components/button-group/button-group.js"></script>
>>>>>>>> origin/main:docs/components/button-group.md
